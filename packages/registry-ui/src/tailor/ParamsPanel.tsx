        ...
        {params.map(({ name }) => (
          <div key={name} className="flex items-center gap-2.5 px-3.5 py-2">
            ...
            <input
              ...
              className="flex-1 bg-muted/50 border border-border rounded-md px-2 py-1 font-mono text-[0.78rem] text-foreground outline-none placeholder:text-neutral-400 focus:border-neutral-400 transition-colors"
            />
          </div>
        ))}
      </div>
