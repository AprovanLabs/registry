...
## `telegram.postUnpinallchatmessages`
...
```ts
telegram.postUnpinallchatmessages(): Promise<{ ok: boolean; result: boolean }>
```

<sub>`POST /unpinAllChatMessages` · `post_unpinallchatmessages`</sub>
