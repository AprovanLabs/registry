export type SpotifyClient = {
   ...
   * Access as: spotify.addItemsToPlaylist(input)
   */
  addItemsToPlaylist: (input: { body?: { uris?: (string)[]; position?: number; [key: string]: unknown }; playlist_id: string; position?: number; uris?: string }) => Promise<{ snapshot_id?: string }>;
  /**
   ...
   * Tags: Playlists, Tracks
   * Access as: spotify.addTracksToPlaylist(input)
   */
  addTracksToPlaylist: (input: { body?: { uris?: (string)[]; position?: number; [key: string]: unknown }; playlist_id: string; position?: number; uris?: string }) => Promise<{ snapshot_id?: string }>;
  /**
   * Change Playlist Details 
   * Tags: Playlists, Library
   * Access as: spotify.changePlaylistDetails(input)
   */
  changePlaylistDetails: (input: { body?: { name?: string; public?: boolean; collaborative?: boolean; description?: string; [key: string]: unknown }; playlist_id: string }) => Promise<{ error: { status: number; message: string } }>;
  /**
   ...
   * Tags: Albums, Library
   * Access as: spotify.removeAlbumsUser(input)
   */
  removeAlbumsUser: (input: { body?: { ids?: (string)[]; [key: string]: unknown }; ids: string }) => Promise<{ error: { status: number; message: string } }>;
  /**
   ...
   * Tags: Episodes, Library
   * Access as: spotify.removeEpisodesUser(input)
   */
  removeEpisodesUser: (input: { body?: { ids?: (string)[]; [key: string]: unknown }; ids: string }) => Promise<{ error: { status: number; message: string } }>;
  /**
   ...
   * Tags: Tracks, Library
   * Access as: spotify.removeTracksUser(input)
   */
  removeTracksUser: (input: { body?: { ids?: (string)[]; [key: string]: unknown }; ids: string }) => Promise<{ error: { status: number; message: string } }>;
  /**
   * Update Playlist Items 
   * Tags: Playlists, Tracks
   * Access as: spotify.reorderOrReplacePlaylistsItems(input)
   */
  reorderOrReplacePlaylistsItems: (input: { body?: { uris?: (string)[]; range_start?: number; insert_before?: number; range_length?: number; snapshot_id?: string; [key: string]: unknown }; playlist_id: string; uris?: string }) => Promise<{ snapshot_id?: string }>;
  /**
   * Update Playlist Items [DEPRECATED] 
   * Tags: Playlists, Tracks
   * Access as: spotify.reorderOrReplacePlaylistsTracks(input)
   */
  reorderOrReplacePlaylistsTracks: (input: { body?: { uris?: (string)[]; range_start?: number; insert_before?: number; range_length?: number; snapshot_id?: string; [key: string]: unknown }; playlist_id: string; uris?: string }) => Promise<{ snapshot_id?: string }>;
  /**
   * Save Albums for Current User 
   * Tags: Albums, Library
   * Access as: spotify.saveAlbumsUser(input)
   */
  saveAlbumsUser: (input: { body?: { ids?: (string)[]; [key: string]: unknown }; ids: string }) => Promise<{ error: { status: number; message: string } }>;
  /**
   ...
   * Tags: Episodes, Library
   * Access as: spotify.saveEpisodesUser(input)
   */
  saveEpisodesUser: (input: { body?: { ids?: (string)[]; [key: string]: unknown }; ids: string }) => Promise<{ error: { status: number; message: string } }>;
  /**
   ...
   */
  saveTracksUser: (input: { body?: { ids?: (string)[]; timestamped_ids?: ({ id: string; added_at: string })[]; [key: string]: unknown } }) => Promise<{ error: { status: number; message: string } }>;
  /**
   * Search for Item 
   * Tags: Search
   ...
   */
  startAUsersPlayback: (input: { body?: { context_uri?: string; uris?: (string)[]; offset?: { [key: string]: unknown }; position_ms?: number; [key: string]: unknown }; device_id?: string }) => Promise<{ error: { status: number; message: string } }>;
  /**
   ...
   */
  transferAUsersPlayback: (input: { body?: { device_ids: (string)[]; play?: boolean; [key: string]: unknown } }) => Promise<{ error: { status: number; message: string } }>;
  /**
   * Unfollow Artists or Users 
   * Tags: Users, Artists, Library
   * Access as: spotify.unfollowArtistsUsers(input)
   */
  unfollowArtistsUsers: (input: { body?: { ids?: (string)[]; [key: string]: unknown }; type: "artist" | "user"; ids: string }) => Promise<{ error: { status: number; message: string } }>;
  /**
   * Unfollow Playlist 
   * Tags: Users, Playlists
