...
- **Provider URL**: https://raw.githubusercontent.com/HubSpot/HubSpot-public-api-spec-collection/main/PublicApiSpecs/CRM/Contacts/Rollouts/424/v3/contacts.json
- **Operations**: 13
- **Authentication**: apiKey, oauth2, apiKey, apiKey
- **Top capabilities**: Basic, Batch, Advanced, Search

## Quick start

```ts
import client from "@utdk/hubspot";
