...
## `twilio.listIncomingPhoneNumberMobile`

[Provider docs](https://support.twilio.com)

```ts
twilio.listIncomingPhoneNumberMobile(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json` · `ListIncomingPhoneNumberMobile`</sub>

## `twilio.createIncomingPhoneNumberMobile`

[Provider docs](https://support.twilio.com)

```ts
twilio.createIncomingPhoneNumberMobile(input: {
...
<sub>`POST /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json` · `CreateIncomingPhoneNumberMobile`</sub>
