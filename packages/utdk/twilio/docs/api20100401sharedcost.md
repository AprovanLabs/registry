...
## `twilio.listAvailablePhoneNumberSharedCost`

[Provider docs](https://support.twilio.com)

```ts
twilio.listAvailablePhoneNumberSharedCost(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/SharedCost.json` · `ListAvailablePhoneNumberSharedCost`</sub>
