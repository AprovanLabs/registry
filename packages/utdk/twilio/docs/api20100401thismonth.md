...
## `twilio.listUsageRecordThisMonth`

[Provider docs](https://support.twilio.com)

```ts
twilio.listUsageRecordThisMonth(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/Usage/Records/ThisMonth.json` · `ListUsageRecordThisMonth`</sub>
