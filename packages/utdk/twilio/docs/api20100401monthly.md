...
## `twilio.listUsageRecordMonthly`

[Provider docs](https://support.twilio.com)

```ts
twilio.listUsageRecordMonthly(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/Usage/Records/Monthly.json` · `ListUsageRecordMonthly`</sub>
