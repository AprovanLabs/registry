...
## `twilio.listUsageRecordYesterday`

[Provider docs](https://support.twilio.com)

```ts
twilio.listUsageRecordYesterday(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/Usage/Records/Yesterday.json` · `ListUsageRecordYesterday`</sub>
