...
## `twilio.listIncomingPhoneNumberTollFree`

[Provider docs](https://support.twilio.com)

```ts
twilio.listIncomingPhoneNumberTollFree(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json` · `ListIncomingPhoneNumberTollFree`</sub>

## `twilio.createIncomingPhoneNumberTollFree`

[Provider docs](https://support.twilio.com)

```ts
twilio.createIncomingPhoneNumberTollFree(input: {
...
<sub>`POST /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json` · `CreateIncomingPhoneNumberTollFree`</sub>
