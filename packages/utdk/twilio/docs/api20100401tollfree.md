...
## `twilio.listAvailablePhoneNumberTollFree`

[Provider docs](https://support.twilio.com)

```ts
twilio.listAvailablePhoneNumberTollFree(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/TollFree.json` · `ListAvailablePhoneNumberTollFree`</sub>
