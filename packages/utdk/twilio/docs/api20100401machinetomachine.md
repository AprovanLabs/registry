...
## `twilio.listAvailablePhoneNumberMachineToMachine`

[Provider docs](https://support.twilio.com)

```ts
twilio.listAvailablePhoneNumberMachineToMachine(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/MachineToMachine.json` · `ListAvailablePhoneNumberMachineToMachine`</sub>
