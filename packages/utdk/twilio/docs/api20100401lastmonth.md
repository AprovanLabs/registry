...
## `twilio.listUsageRecordLastMonth`

[Provider docs](https://support.twilio.com)

```ts
twilio.listUsageRecordLastMonth(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/Usage/Records/LastMonth.json` · `ListUsageRecordLastMonth`</sub>
