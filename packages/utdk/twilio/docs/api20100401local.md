...
## `twilio.listAvailablePhoneNumberLocal`

[Provider docs](https://support.twilio.com)

```ts
twilio.listAvailablePhoneNumberLocal(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Local.json` · `ListAvailablePhoneNumberLocal`</sub>
