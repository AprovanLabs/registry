...
## `twilio.listUsageRecordAllTime`

[Provider docs](https://support.twilio.com)

```ts
twilio.listUsageRecordAllTime(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/Usage/Records/AllTime.json` · `ListUsageRecordAllTime`</sub>
