...
## `twilio.listAvailablePhoneNumberVoip`

[Provider docs](https://support.twilio.com)

```ts
twilio.listAvailablePhoneNumberVoip(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Voip.json` · `ListAvailablePhoneNumberVoip`</sub>
