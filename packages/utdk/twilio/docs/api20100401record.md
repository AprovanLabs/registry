...
## `twilio.listUsageRecord`

Retrieve a list of usage-records belonging to the account used to make the request — [Provider docs](https://support.twilio.com)

```ts
twilio.listUsageRecord(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/Usage/Records.json` · `ListUsageRecord`</sub>
