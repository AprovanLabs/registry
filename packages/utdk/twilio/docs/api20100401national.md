...
## `twilio.listAvailablePhoneNumberNational`

[Provider docs](https://support.twilio.com)

```ts
twilio.listAvailablePhoneNumberNational(input: {
...
<sub>`GET /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/National.json` · `ListAvailablePhoneNumberNational`</sub>
