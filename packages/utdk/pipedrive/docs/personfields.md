...
## `pipedrive.deletePersonFields`

Delete multiple person fields in bulk

```ts
pipedrive.deletePersonFields(input: {
  /** The comma-separated field IDs to delete */
  ids: string;
}): Promise<{ success?: boolean } & { data?: { id?: (number)[] } }>
```

<sub>`DELETE /personFields` · `deletePersonFields`</sub>

## `pipedrive.getPersonFields`

Get all person fields

```ts
pipedrive.getPersonFields(input: {
  /** Pagination start */
  start?: number;
...
<sub>`GET /personFields` · `getPersonFields`</sub>

## `pipedrive.addPersonField`

Add a new person field

```ts
pipedrive.addPersonField(input: {
...
<sub>`POST /personFields` · `addPersonField`</sub>

## `pipedrive.deletePersonField`

Delete a person field

```ts
pipedrive.deletePersonField(input: {
  /** The ID of the field */
  id: number;
}): Promise<{ success?: boolean } & { data?: { id?: number } }>
```

<sub>`DELETE /personFields/{id}` · `deletePersonField`</sub>

## `pipedrive.getPersonField`

Get one person field

```ts
pipedrive.getPersonField(input: {
  /** The ID of the field */
  id: number;
}): Promise<{ success?: boolean } & { data?: { id?: number | null; key?: string; name?: string; order_nr?: number; field_type?: "address" | "date" | "daterange" | "double" | "enum" | "monetary" | "org" | "people" | "phone" | "set" | "text" | "time" | "timerange" | "user" | "varchar" | "varchar_auto" | "visible_to"; add_time?: string; update_time?: string | null; last_updated_by_user_id?: number | null; creat...>
```

<sub>`GET /personFields/{id}` · `getPersonField`</sub>

## `pipedrive.updatePersonField`

Update a person field

```ts
pipedrive.updatePersonField(input: {
  /** The name of the field */
  name?: string;
...
<sub>`PUT /personFields/{id}` · `updatePersonField`</sub>
