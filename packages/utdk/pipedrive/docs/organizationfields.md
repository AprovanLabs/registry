...
## `pipedrive.deleteOrganizationFields`

Delete multiple organization fields in bulk

```ts
pipedrive.deleteOrganizationFields(input: {
  /** The comma-separated field IDs to delete */
  ids: string;
}): Promise<{ success?: boolean } & { data?: { id?: (number)[] } }>
```

<sub>`DELETE /organizationFields` · `deleteOrganizationFields`</sub>
...
```ts
pipedrive.getOrganizationFields(input: {
  /** Pagination start */
  start?: number;
...
<sub>`GET /organizationFields` · `getOrganizationFields`</sub>

## `pipedrive.addOrganizationField`

Add a new organization field

```ts
pipedrive.addOrganizationField(input: {
...
<sub>`POST /organizationFields` · `addOrganizationField`</sub>

## `pipedrive.deleteOrganizationField`

Delete an organization field

```ts
pipedrive.deleteOrganizationField(input: {
  /** The ID of the field */
  id: number;
}): Promise<{ success?: boolean } & { data?: { id?: number } }>
```

<sub>`DELETE /organizationFields/{id}` · `deleteOrganizationField`</sub>

## `pipedrive.getOrganizationField`

Get one organization field

```ts
pipedrive.getOrganizationField(input: {
  /** The ID of the field */
  id: number;
}): Promise<{ success?: boolean } & { data?: { id?: number | null; key?: string; name?: string; order_nr?: number; field_type?: "address" | "date" | "daterange" | "double" | "enum" | "monetary" | "org" | "people" | "phone" | "set" | "text" | "time" | "timerange" | "user" | "varchar" | "varchar_auto" | "visible_to"; add_time?: string; update_time?: string | null; last_updated_by_user_id?: number | null; creat...>
```

<sub>`GET /organizationFields/{id}` · `getOrganizationField`</sub>

## `pipedrive.updateOrganizationField`

Update an organization field

```ts
pipedrive.updateOrganizationField(input: {
  /** The name of the field */
  name?: string;
...
<sub>`PUT /organizationFields/{id}` · `updateOrganizationField`</sub>
