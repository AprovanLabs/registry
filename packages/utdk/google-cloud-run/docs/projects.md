...
16 operations · `@utdk/google-cloud-run`

```ts
import googleCloudRun from "@utdk/google-cloud-run";
```

## `googleCloudRun.runProjectsLocationsServicesRevisionsDelete`

Deletes a Revision. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesRevisionsDelete(input: {
...
<sub>`DELETE /v2/{name}` · `run.projects.locations.services.revisions.delete`</sub>

## `googleCloudRun.runProjectsLocationsServicesRevisionsGet`

Gets information about a Revision. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesRevisionsGet(input: {
...
<sub>`GET /v2/{name}` · `run.projects.locations.services.revisions.get`</sub>

## `googleCloudRun.runProjectsLocationsServicesPatch`

Updates a Service. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesPatch(input: {
...
<sub>`PATCH /v2/{name}` · `run.projects.locations.services.patch`</sub>

## `googleCloudRun.runProjectsLocationsJobsRun`

Triggers creation of a new Execution of this Job. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsJobsRun(input: {
...
<sub>`POST /v2/{name}:run` · `run.projects.locations.jobs.run`</sub>

## `googleCloudRun.runProjectsLocationsOperationsWait`

Waits until the specified long-running operation is done or reaches at most a specified timeout, returning the latest state. If the operation is already done, the latest state is immediately returned. If the timeout specified is greater than the default HTTP/RPC timeout, the HTTP/RPC timeout is used. If the server does not support this method, it returns `google.rpc.Code.UNIMPLEMENTED`. Note that this method is on a best-effort basis. It may return the latest state before the specified timeout (including immediately), meaning even an immediate response is no guarantee that the operation is done. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsOperationsWait(input: {
...
<sub>`POST /v2/{name}:wait` · `run.projects.locations.operations.wait`</sub>

## `googleCloudRun.runProjectsLocationsOperationsList`

Lists operations that match the specified filter in the request. If the server doesn't support this method, it returns `UNIMPLEMENTED`. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsOperationsList(input: {
...
<sub>`GET /v2/{name}/operations` · `run.projects.locations.operations.list`</sub>

## `googleCloudRun.runProjectsLocationsJobsExecutionsList`

Lists Executions from a Job. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsJobsExecutionsList(input: {
...
<sub>`GET /v2/{parent}/executions` · `run.projects.locations.jobs.executions.list`</sub>

## `googleCloudRun.runProjectsLocationsJobsList`

Lists Jobs. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsJobsList(input: {
...
<sub>`GET /v2/{parent}/jobs` · `run.projects.locations.jobs.list`</sub>

## `googleCloudRun.runProjectsLocationsJobsCreate`

Creates a Job. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsJobsCreate(input: {
...
<sub>`POST /v2/{parent}/jobs` · `run.projects.locations.jobs.create`</sub>

## `googleCloudRun.runProjectsLocationsServicesRevisionsList`

Lists Revisions from a given Service, or from a given location. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesRevisionsList(input: {
...
<sub>`GET /v2/{parent}/revisions` · `run.projects.locations.services.revisions.list`</sub>

## `googleCloudRun.runProjectsLocationsServicesList`

Lists Services. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesList(input: {
...
<sub>`GET /v2/{parent}/services` · `run.projects.locations.services.list`</sub>

## `googleCloudRun.runProjectsLocationsServicesCreate`

Creates a new Service in a given project and location. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesCreate(input: {
  /** Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects. Cloud Run API v2 does not support annotations with `run.googleapis.com`, `cloud.googleapis.com`, `serving.knative.dev`, or `autoscaling.knative.dev` namespaces, and they will be rejected in new resources. All system annotations in v1 now have a corresponding field in v2 Service. This field follows Kubernetes annotations' namespacing, limits, and rules. */
  annotations?: { [key: string]: string | undefined };
  /** Settings for the Binary Authorization feature. */
  binaryAuthorization?: GoogleCloudRunV2BinaryAuthorization;
...
<sub>`POST /v2/{parent}/services` · `run.projects.locations.services.create`</sub>

## `googleCloudRun.runProjectsLocationsJobsExecutionsTasksList`

Lists Tasks from an Execution of a Job. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsJobsExecutionsTasksList(input: {
...
<sub>`GET /v2/{parent}/tasks` · `run.projects.locations.jobs.executions.tasks.list`</sub>

## `googleCloudRun.runProjectsLocationsServicesGetIamPolicy`

Gets the IAM Access Control policy currently in effect for the given Cloud Run Service. This result does not include any inherited policies. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesGetIamPolicy(input: {
...
<sub>`GET /v2/{resource}:getIamPolicy` · `run.projects.locations.services.getIamPolicy`</sub>

## `googleCloudRun.runProjectsLocationsServicesSetIamPolicy`

Sets the IAM Access control policy for the specified Service. Overwrites any existing policy. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesSetIamPolicy(input: {
...
<sub>`POST /v2/{resource}:setIamPolicy` · `run.projects.locations.services.setIamPolicy`</sub>

## `googleCloudRun.runProjectsLocationsServicesTestIamPermissions`

Returns permissions that a caller has on the specified Project. There are no permissions required for making this API call. — [Provider docs](https://cloud.google.com/run/)

```ts
googleCloudRun.runProjectsLocationsServicesTestIamPermissions(input: {
...
<sub>`POST /v2/{resource}:testIamPermissions` · `run.projects.locations.services.testIamPermissions`</sub>
