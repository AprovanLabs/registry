...
export type Colors = {
  ...
  calendar?: { [key: string]: ColorDefinition | undefined };
  ...
  event?: { [key: string]: ColorDefinition | undefined };
...
export type FreeBusyResponse = {
  ...
  calendars?: { [key: string]: FreeBusyCalendar | undefined };
  /** Expansion of groups. */
  groups?: { [key: string]: FreeBusyGroup | undefined };
