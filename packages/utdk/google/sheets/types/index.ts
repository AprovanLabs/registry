import type { AppendValuesResponse, BatchClearValuesByDataFilterResponse, BatchClearValuesResponse, BatchGetValuesByDataFilterResponse, BatchGetValuesResponse, BatchUpdateSpreadsheetResponse, BatchUpdateValuesByDataFilterResponse, BatchUpdateValuesResponse, ClearValuesRequest, ClearValuesResponse, DataFilter, DataFilterValueRange, DataSource, DataSourceRefreshSchedule, DeveloperMetadata, NamedRange, Request, SearchDeveloperMetadataResponse, Sheet, SheetProperties, Spreadsheet, SpreadsheetProperties, UpdateValuesResponse, ValueRange } from "./schemas.js";

export type GoogleSheetsClient = {
  /**
   * Creates a spreadsheet, returning the newly created spreadsheet.
   */
  sheetsSpreadsheetsCreate: (input: {
   ...
   */
  sheetsSpreadsheetsDeveloperMetadataGet: (input: {
   ...
   */
  sheetsSpreadsheetsDeveloperMetadataSearch: (input: {
   ...
   */
  sheetsSpreadsheetsSheetsCopyTo: (input: {
   ...
   */
  sheetsSpreadsheetsValuesGet: (input: {
   ...
   */
  sheetsSpreadsheetsValuesUpdate: (input: {
   ...
   */
  sheetsSpreadsheetsValuesAppend: (input: {
    /** The major dimension of the values. For output, if the spreadsheet data is: `A1=1,B1=2,A2=3,B2=4`, then requesting `range=A1:B2,majorDimension=ROWS` will return `[[1,2],[3,4]]`, whereas requesting `range=A1:B2,majorDimension=COLUMNS` will return `[[1,3],[2,4]]`. For input, with `range=A1:B2,majorDimension=ROWS` then `[[1,2],[3,4]]` will set `A1=1,B1=2,A2=3,B2=4`. With `range=A1:B2,majorDimension=COLUMNS` then `[[1,2],[3,4]]` will set `A1=1,B1=3,A2=2,B2=4`. When writing, if this field is not set, it defaults to ROWS. */
    majorDimension?: "DIMENSION_UNSPECIFIED" | "ROWS" | "COLUMNS";
    /** The range the values cover, in [A1 notation](/sheets/api/guides/concepts#cell). For output, this range indicates the entire requested range, even though the values will exclude trailing rows and columns. When appending values, this field represents the range to search for a table, after which values will be appended. */
    range?: string;
   ...
   */
  sheetsSpreadsheetsValuesClear: (input: {
   ...
   */
  sheetsSpreadsheetsValuesBatchClear: (input: {
   ...
   */
  sheetsSpreadsheetsValuesBatchClearByDataFilter: (input: {
   ...
   */
  sheetsSpreadsheetsValuesBatchGet: (input: {
    /** The ID of the spreadsheet to retrieve data from. */
    spreadsheetId: string;
    /** V1 error format. */
    "$.xgafv"?: "1" | "2";
   ...
   */
  sheetsSpreadsheetsValuesBatchGetByDataFilter: (input: {
   ...
   */
  sheetsSpreadsheetsValuesBatchUpdate: (input: {
   ...
   */
  sheetsSpreadsheetsValuesBatchUpdateByDataFilter: (input: {
   ...
   */
  sheetsSpreadsheetsBatchUpdate: (input: {
   ...
   */
  sheetsSpreadsheetsGetByDataFilter: (input: {
