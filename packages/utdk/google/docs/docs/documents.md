...
Creates a blank document using the title given in the request. Other fields in the request, including any provided content, are ignored. Returns the created document. — [Provider docs](https://developers.google.com/docs/)

```ts
docs.docsDocumentsCreate(input: {
...
<sub>`POST /v1/documents` · `docs.documents.create`</sub>

## `docs.docsDocumentsGet`

Gets the latest version of the specified document. — [Provider docs](https://developers.google.com/docs/)

```ts
docs.docsDocumentsGet(input: {
...
<sub>`POST /v1/documents/{documentId}:batchUpdate` · `docs.documents.batchUpdate`</sub>
