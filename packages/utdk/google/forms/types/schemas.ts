...
export type PageBreakItem = { [key: string]: unknown };
...
export type RenewWatchRequest = { [key: string]: unknown };
...
/** A text item. */
export type TextItem = { [key: string]: unknown };
...
export type Watch = {
  ...
  errorType?: "ERROR_TYPE_UNSPECIFIED" | "PROJECT_NOT_AUTHORIZED" | "NO_USER_ACCESS" | "OTHER_ERRORS";
