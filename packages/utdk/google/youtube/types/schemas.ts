...
export type TestItemTestItemSnippet = { [key: string]: unknown };
...
export type TokenPagination = { [key: string]: unknown };
...
export type VideoProjectDetails = { [key: string]: unknown };
