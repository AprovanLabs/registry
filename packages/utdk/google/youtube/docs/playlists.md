...
<sub>`DELETE /youtube/v3/playlists` · `youtube.playlists.delete`</sub>

## `youtube.youtubePlaylistsList`

Retrieves a list of resources, possibly filtered. — [Provider docs](https://developers.google.com/youtube/)

```ts
youtube.youtubePlaylistsList(input: {
  /** V1 error format. */
  "$.xgafv"?: "1" | "2";
  /** OAuth access token. */
  access_token?: string;
...
<sub>`GET /youtube/v3/playlists` · `youtube.playlists.list`</sub>

## `youtube.youtubePlaylistsInsert`

Inserts a new resource into this collection. — [Provider docs](https://developers.google.com/youtube/)

```ts
youtube.youtubePlaylistsInsert(input: {
...
<sub>`POST /youtube/v3/playlists` · `youtube.playlists.insert`</sub>

## `youtube.youtubePlaylistsUpdate`

Updates an existing resource. — [Provider docs](https://developers.google.com/youtube/)

```ts
youtube.youtubePlaylistsUpdate(input: {
  /** The contentDetails object contains information like video count. */
  contentDetails?: PlaylistContentDetails;
  /** Etag of this resource. */
  etag?: string;
...
<sub>`PUT /youtube/v3/playlists` · `youtube.playlists.update`</sub>
