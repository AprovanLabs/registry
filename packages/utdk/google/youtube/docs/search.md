...
Retrieves a list of search resources — [Provider docs](https://developers.google.com/youtube/)

```ts
youtube.youtubeSearchList(input: {
  /** V1 error format. */
  "$.xgafv"?: "1" | "2";
  /** OAuth access token. */
  access_token?: string;
...
<sub>`GET /youtube/v3/search` · `youtube.search.list`</sub>
