import type { FullRepository, GlobalAdvisory, RepositoryAdvisory, SecurityAdvisoryCreditTypes, SecurityAdvisoryEcosystems } from "./schemas.js";

export type SecurityAdvisoriesOperations = {
  /**
   * List global security advisories
   * @see https://docs.github.com/rest/security-advisories/global-advisories#list-global-security-advisories
   */
  listGlobalAdvisories: (input: {
   ...
   */
  listOrgRepositoryAdvisories: (input: {
   ...
   */
  listRepositoryAdvisories: (input: {
   ...
   */
  createRepositoryAdvisory: (input: {
   ...
   */
  createPrivateVulnerabilityReport: (input: {
    /** A short summary of the advisory. */
    summary: string;
    /** A detailed description of what the advisory impacts. */
    description: string;
   ...
   */
  updateRepositoryAdvisory: (input: {
    /** A short summary of the advisory. */
    summary?: string;
    /** A detailed description of what the advisory impacts. */
    description?: string;
   ...
   */
  createRepositoryAdvisoryCveRequest: (input: {
    /** The account owner of the repository. The name is not case sensitive. */
    owner: string;
    /** The name of the repository without the `.git` extension. The name is not case sensitive. */
    repo: string;
