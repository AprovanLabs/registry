...
Creates a completion for the provided prompt and parameters. — [Provider docs](https://help.openai.com/)

```ts
openai.createCompletion(input: {
...
<sub>`POST /completions` · `createCompletion`</sub>
