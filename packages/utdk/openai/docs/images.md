...
Creates an edited or extended image given one or more source images and a prompt. This endpoint only supports `gpt-image-1` and `dall-e-2`. — [Provider docs](https://help.openai.com/)

```ts
openai.createImageEdit(input: {
...
<sub>`POST /images/edits` · `createImageEdit`</sub>

## `openai.createImage`

Creates an image given a prompt. [Learn more](/docs/guides/images). — [Provider docs](https://help.openai.com/)

```ts
openai.createImage(input: {
...
<sub>`POST /images/generations` · `createImage`</sub>

## `openai.createImageVariation`

Creates a variation of a given image. This endpoint only supports `dall-e-2`. — [Provider docs](https://help.openai.com/)

```ts
openai.createImageVariation(input: {
...
<sub>`POST /images/variations` · `createImageVariation`</sub>
