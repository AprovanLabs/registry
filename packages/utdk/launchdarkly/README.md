...
- **Provider URL**: https://app.launchdarkly.com/api/v2/openapi.json
- **Operations**: 380
- **Authentication**: apiKey
- **Top capabilities**: AI Configs, Account usage (beta), Segments, Feature flags, Approvals

## Quick start

```ts
import client from "@utdk/launchdarkly";
