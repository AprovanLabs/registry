...
## `elevenlabs.createAudioNativeProject`

Creates Audio Native Enabled Project.

```ts
elevenlabs.createAudioNativeProject(input: {
  /** Project name. */
  name: string;
...
<sub>`POST /v1/audio-native` · `create_audio_native_project`</sub>

## `elevenlabs.audioNativeProjectUpdateContentEndpoint`

Update Audio-Native Project Content

```ts
elevenlabs.audioNativeProjectUpdateContentEndpoint(input: {
...
<sub>`POST /v1/audio-native/{project_id}/content` · `audio_native_project_update_content_endpoint`</sub>

## `elevenlabs.getAudioNativeProjectSettingsEndpoint`

Get Audio Native Project Settings

```ts
elevenlabs.getAudioNativeProjectSettingsEndpoint(input: {
  /** The ID of the Studio project. */
  project_id: string;
}, options?: { headers?: { "xi-api-key"?: string | null } }): Promise<GetAudioNativeProjectSettingsResponseModel>
```

<sub>`GET /v1/audio-native/{project_id}/settings` · `get_audio_native_project_settings_endpoint`</sub>

## `elevenlabs.audioNativeUpdateContentFromUrl`

Update Audio-Native Content From Url

```ts
elevenlabs.audioNativeUpdateContentFromUrl(input: {
...
<sub>`POST /v1/audio-native/content` · `audio_native_update_content_from_url`</sub>
