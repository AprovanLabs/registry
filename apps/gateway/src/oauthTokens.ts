...
/** In-memory client-credentials token cache, keyed by workspace+provider. */
const clientTokenCache = new Map<string, OAuthTokenSet>();

/** Clear the client-credentials cache (used in tests). */
